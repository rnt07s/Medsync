...
export default function MedSyncBusinessContactForm() {
  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-8 max-w-2xl mx-auto mb-5 mt-36">
      <h2 className="text-2xl font-bold mb-2 text-gray-800">Contact MedSync for Business</h2>
          ...
          <>
            ...
            <div className="flex items-center">
              ...
              <label htmlFor="consent" className="ml-2 block text-sm text-gray-900">
                I agree to be contacted about MedSync solutions
              </label>
            </div>
